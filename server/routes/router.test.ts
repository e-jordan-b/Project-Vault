...
describe('GET /project Routes test', () => {
  ...
  test('Route /projects/:id endpoint should return a 400 status code: ', async () => {
    await request(app).get('/projects/222').expect(400)
  })
  ...
  test('Route /projects/following/:id endpoint should return a 400 status code: ', async () => {
    await request(app).get('/projects/following/222').expect(400)
  })
  ...
  test('Route /projects/personal/:id endpoint should return a 400 status code: ', async () => {
    await request(app).get('/projects/personal/222').expect(400)
  })
